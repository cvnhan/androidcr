package com.cvnhan.core.ui.fragment;
/**
...
public class NCMCFragmentNavigator {
    ...
    private NCMCFragmentNavigator(final FragmentActivity activity, int fragmentContainerId) {
        this.fragmentContainerId = fragmentContainerId;
        this.fragmentManager = activity.getSupportFragmentManager();
    }

    public static NCMCFragmentNavigator create(FragmentActivity activity, int fragmentContainerId) {
        return new NCMCFragmentNavigator(activity, fragmentContainerId);
    }
