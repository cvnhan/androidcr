...
public class FragmentNav {
    ...
    private FragmentNav(final FragmentActivity activity, int fragmentContainerId) {
        this.fragmentContainerId = fragmentContainerId;
        this.fragmentManager = activity.getSupportFragmentManager();
    }

    public static FragmentNav create(FragmentActivity activity, int fragmentContainerId) {
        return new FragmentNav(activity, fragmentContainerId);
    }
