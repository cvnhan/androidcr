package com.cvnhan.androidcr.core.ui.adapter;
/**
...
public abstract class NCMCAdapterRecyclerTyped<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {

    private final String TAG;
    private List<T> dataSet = new ArrayList<T>();

    public NCMCAdapterRecyclerTyped() {
